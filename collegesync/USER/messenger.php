...
<div class="container" style="border:1px solid blue;">
	<div class="row">
		<div class="col-sm-4" style="border:1px solid red;max-height: 536px;overflow-y: scroll;">
			...
			<legend style="background: #494949;color: #fff;"><center>Friends</center></legend>

			
			<div class="panel panel-success col-sm-12 col-sm-offset-0" style=" ">
				  <div class="panel-body">
				  	<!-- <legend style="background: #494949;color: #fff;"><center>Contacts</center></legend> -->
				  	<form method="GET" action="friendsearch.php">
				  	<div class="row">
				  	<div class="col-sm-7">
				  	<input type="text" placeholder="search friend" class="form-control" name="searchinput" value="">
				  	</div>
				  	<div class="col-sm-5">
				  	<input type="submit" class="form-control btn-primary" name="search" value="search">
				  	</div>
				  	</div>
				  	</form>	
				  </div>
          	...
          	if($row[0]!=$_SESSION['id'])
          	{
          		...
          		else
          		{
         			echo'
          			...
          			<div><div style=" padding:15px;margin-left:40px;">' . $row[1].' '.$row[2].'';
          				
          			// 	  if($row[14]==1)
          			// {
          			// 	echo"<span class='pull-right dot'></span>";
