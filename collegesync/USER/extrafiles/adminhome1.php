      ...
      echo"<div class='col-sm-9 col-sm-offset-1'>";
        ...
        echo"<div class='panel panel-danger'>";
          echo"<div class='panel-heading '>";
            ...
            echo"$row[2]";
            echo"<div id='del'>";
            echo"<button onclick='del(this.value)' value=$row[0] class=''><span class='' >X</button>";
            echo"</div>";
        ...
        echo"<div class='col-sm-12 col-xs-offset-3'>";
         echo"<br><a href='$row[3]' target='_blank' ><img src='$row[3]' alt='image not found' style='max-height: 150px; max-width: 250px;'></a>";
        //echo "$row[3]";       
        echo"</div>";
