...
<?php
	if(isset($_POST['Next']))
	{
		...
		mysql_query("insert into user_secret_quotes(REG_ID,Question1,Answer1) values ('$userid','$que1','$ans1')");
		header('location:../fb_step3/Secret_Question2.php?id='.$user.'' );
...
<?php
		...
		{
			header('location:s../fb_step3/Secret_Question2.php?id='.$user.'' );
