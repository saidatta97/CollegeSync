  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="home.php" class="glyphicon glyphicon-home">Home</a></li>
        <li><a href="messenger.php">Message</a></li>
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class='glyphicon glyphicon-book'></span> Notes<span class="caret"></span></a>
