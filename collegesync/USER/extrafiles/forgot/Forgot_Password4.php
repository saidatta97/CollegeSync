...
<?php
	...
	$que1=mysql_query("select * from user_secret_quotes where REG_ID=$userid and Answer2='$ans2'");
	$count1=mysql_num_rows($que1);
	
	if($count1>0)
	{
		$que2=mysql_query("select * from col_registration where REG_ID=$userid");
...
<div style="position:absolute; left:30%; top:50%;"> <h4> Your Password is:&nbsp;&nbsp;&nbsp;<?php echo $password; ?> </h4> </div>
 ...
 <a href="../mainlogin.php" style="text-decoration:none;"> <div style="position:absolute; left:45%; top:63%;">  <input type="button" value="Login" id="next"> </div> </a>
