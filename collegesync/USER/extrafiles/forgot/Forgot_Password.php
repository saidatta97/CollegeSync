...
<form action="Forgot_Password2.php"  method="post">
	<div style="position:absolute; left:32%; top:45.6%;"> <h4> Enter Your Username: </h4> </div>
	<div style="position:absolute; left:43%; top:44.5%;"> <h4> <input type="text" name="user" style="height:35; width:300; font-size:18px;"> </h4> </div>
