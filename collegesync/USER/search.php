 ...
 include("conn.php");
	...
	<table border="0">
		...
		<td bgcolor="#FFFFFF" style="padding-right:7, margin-left: 50px;" id=""><?php echo"<a href='viewprofile1.php?id=".$rec1[0]."' style=' text-decoration:none; text-transform:capitalize; color:#3B5998;' id=''>"?>
			<img src="<?php echo$rec1[12];?> " alt='No profile pic '  style="max-width: 170px; max-height: 170px; margin-left: 50px;" ></a>  </td>
               <?php
              }
              else
              {
?>
               <tr>
		<td bgcolor="#FFFFFF" style="padding-right:7, margin-left: 50px;" id=""><?php echo"<a href='viewprofile1.php?id=".$rec1[0]."' style=' text-decoration:none; text-transform:capitalize; color:#3B5998;' id=''>"?>
			<img src="userdp/no_image.png" alt='No profile pic '  style="max-width: 170px; max-height: 170px; margin-left: 50px;" ></a>  </td>
  <?php             
