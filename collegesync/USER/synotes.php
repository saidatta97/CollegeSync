    ...
    <br>
         <button type="button" class="btn btn-default btn-lg"><li class="dropdown glyphicon glyphicon-user">
          ...
          <ul class="dropdown-menu">
            <li><a href="synotesgallery.php">Images</a></li>
            <li><a href="synotesfiles.php">Files</a></li>
          </ul>
        </li>
        </button>
        <br>
  ...
  <div class="panel-heading">
    <div class="row">
      ...
      <div class="col-sm-6 col-sm-offset-2">
       ...
       <div class="row">
      <div class="col-sm-6 col-sm-offset-2">
              <label><br/><strong>Description</strong></label><br/><br/>
...
die(mysql_error());
      ...
      $user=$_SESSION['user'];
          include("conn.php");
            $select=mysql_query("select * from notes where `clas`='SY' order by notes_id desc");
    ...
    <div class='row'>
      ...
      <div class='row'>
        ...
        echo"<a href='synotes/$row1[5]' target='_blank' ><img src='synotes/$row1[5]' alt='$name' style='width: 170px; height: 170px;'/></a><br>";
      }
      else
      {
          echo"<a href='synotes/$row1[5]' target='_blank' ><span class='glyphicon glyphicon-download'></span><em>$name</em></a><br>";
