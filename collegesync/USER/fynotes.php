...
<div class="container-fluid text-center">    
  ...
  $link=$_POST['link'];
  move_uploaded_file($temp,"fynotes/".$name);
...
die(mysql_error());
      ...
      $user=$_SESSION['user'];
          include("conn.php");
            $select=mysql_query("select * from notes where `clas`='FY' order by notes_id desc");
    ...
    <div class='row'>
      ...
      <div class='row'>
        ...
        echo"<a href='fynotes/$row1[5]' target='_blank' ><img src='fynotes/$row1[5]' alt='$name' style='width: 170px; height: 170px;'/></a><br>";
      }
          if (strpos($row1[5], '.PDF') !== false || strpos($row1[5], '.pptx') !== false || strpos($row1[5], '.doc') !== false)    {
          echo"<a href='fynotes/$row1[5]' target='_blank' ><span class='glyphicon glyphicon-download'></span><em>$name</em></a><br>";
