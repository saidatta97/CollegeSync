...
<body oncontextmenu="return false" style="background:  #B0C4DE;">
<?php
include("nav.php");
?>
<?php
...
?>
      ...
      <div class="col-lg-9 col-sm-offset-1">
        <div class="panel panel-danger">
          ...
          <div class="panel-body bg-warning">
            <div class="row">
          <div class="col-sm-6  col-xs-2  col-sm-offset-3">
        ...
        <div class="row">
          ...
          <br>
        <div class="row">
          <div class="col-sm-2  col-xs-2  col-sm-offset-5">
            
            <center><input type="submit" value="Post" name="post" class="form-control btn-primary btn-(size) col-sm-11"></center>
          </div>
        </div>  
          </div>
    ...
    <?php
            ...
            $query="insert into wallpost values('',$userid, '".$postname."', '".$_SESSION['user']."', '".$targetfile."','',now())";
      ...
      echo"<div class='col-sm-9 col-sm-offset-1 '>";
        ...
        echo"<div class='panel panel-danger'>";
          echo"<div class='panel-heading '>";
            ...
            {
            echo"<div id='del'>";
            echo"<a href='deletepost.php?id=$row[0]' name='de'>X</a>";
