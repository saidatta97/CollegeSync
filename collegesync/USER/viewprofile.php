...
<div class="container-fluid text-center">    
  <div class="row content">
      ...
      <div class='col-lg-9 col-sm-offset-1'>
          ...
          <div class='panel-body bg-warning'>
              ...
              else
              {
        		...
        		<div class='row'>
					...
					<input type='text' name='' value='$user' placeholder='first name' class='form-control' required disabled=''>
					</div>	
					<div class='col-lg-3 col-lg-offset-0'>
		...
		<div class='row'>
			...
			<div class='row'>
					...
					<div class='col-lg-6' >
					<input class='form-control' type='text' name='' value='$row[9]' required disabled><br>
					</div>
				</div>
    ...
    <div class="col-sm-2 sidenav">
      ...
      <div class="well">
        <a href="impnotes"><strong>Impotrant Notes</strong> </a>
      </div>
    </div>
  </div>
</div>
