    ...
    <br>
         <button type="button" class="btn btn-default btn-lg"><li class="dropdown glyphicon glyphicon-user">
          ...
          <ul class="dropdown-menu">
            <li><a href="tynotesgallery.php">Images</a></li>
            <li><a href="tynotesfiles.php">Files</a></li>
          </ul>
        </li>
        </button>
        <br>
  ...
  <div class="panel-heading">
    <div class="row">
      ...
      <div class="col-sm-6 col-sm-offset-2">
              ...
              <center><textarea class="form-control" rows="auto" name="des" required=""></textarea ><br/>
      ...
      <div class="col-sm-2 col-sm-offset-2">
              <label><br/><strong>RATING</strong></label><br/><br/> <br>    
        </div><br>
...
die(mysql_error());
      ...
      $user=$_SESSION['user'];
          include("conn.php");
            $select=mysql_query("select * from notes where `clas`='TY' order by notes_id desc");
    ...
    <div class='row'>
      ...
      <div class='col-sm-6 col-sm-offset-2'>
        ...
        <input type='text' class='form-control' value='$row1[2]'>
        </div>
        </div>
      ...
      <div class='row'>
       ...
       if (strpos($row1[5], '.jpg') !== false || strpos($row1[5], '.jpeg') !== false || strpos($row1[5], '.png') !== false) {
        ...
        echo"<a href='tynotes/$row1[5]' target='_blank' ><img src='tynotes/$row1[5]' alt='$name' style='width: 170px; height: 170px;'/></a><br>";
      }
   if (strpos($row1[5], '.pptx') !== false || strpos($row1[5], '.doc') !== false || strpos($row1[5], '.pdf') !== false) {
             echo"<a href='tynotes/$row1[5]' target='_blank' ><span class='glyphicon glyphicon-download'></span><em>$name</em></a><br>";
