...
<div class="container-fluid text-center">    
  ...
  $link=$_POST['link'];
  move_uploaded_file($temp,"../USER/synotes/".$name);
...
die(mysql_error());
    ...
    <div class='row'>
      ...
      <div class='row'>
        ...
        echo"<a href='../USER/synotes/$row1[5]' target='_blank' ><img src='../USER/synotes/$row1[5]' alt='$name' style='width: 170px; height: 170px;'/></a><br>";
      }
      else
      {
          echo"<a href='../USER/synotes/$row1[5]' target='_blank' ><span  class='glyphicon glyphicon-download' style='font-size:20px;'></span><em>$name</em></a><br>";
