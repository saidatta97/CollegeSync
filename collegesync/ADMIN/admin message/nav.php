	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="myNavbar fixedbar">
	      <ul class="nav navbar-nav" id="fixedbar">
	       ...
	       <!--  <a href="impnotes.php" id="imp_notes" name="imp_notes"><span class="label label-pill label-danger count1" style="border-radius:10px;"></span><strong>Impotrant Notes</strong> </a> -->
	      ...
	      <div class="input-group">
	        <input type="text" class="form-control" placeholder="Search" id="Search" name="Search" onkeyup="searching();">
