...
<?php     if (strpos($row[7], '.jpg') !== false) {
  ...
  $link=$_POST['link'];
  move_uploaded_file($temp,"../USER/tynotes/".$name);
    ...
    <div class='row'>
      ...
      <div class='row'>
       ...
       if (strpos($row1[5], '.jpg') !== false || strpos($row1[5], '.jpeg') !== false || strpos($row1[5], '.png') !== false) {
        ...
        echo"<a href='../USER/tynotes/$row1[5]' target='_blank' ><img src='../USER/tynotes/$row1[5]' alt='$name' style='width: 170px; height: 170px;'/></a><br>";
      }
      else
      {
          echo"<a href='../USER/tynotes/$row1[5]' target='_blank' ><span  class='glyphicon glyphicon-download' style='font-size:20px;'></span><em>$name</em></a><br>";
