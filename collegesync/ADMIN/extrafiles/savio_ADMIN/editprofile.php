...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <img src="<?php echo$row[7];?>" style="max-width: 170px; max-height: 170px;" class="img img-responsive img-circle">
      ...
      <div class="col-lg-9 col-sm-offset-1">
        ...
        <br>
			...
			<div class="row">
				...
				<div class="col-lg-6">
				<textarea class="form-control" cols="30" rows="2" name="add" required> <?php echo$row[2];?> </textarea><br>
				</div>
      </div>
			...
			<div class="row">
				...
				<div class="col-lg-6" >
				<input type="Number" value="<?php echo$row[3];?>" name="mobile" required class="form-control" minlength="10">
				</div> 
			</div>
          ...
          <div class="col-lg-6">
          <input type="E-mail" name="email" class="form-control" value="<?php echo$row[4];?>"><br>
          </div>
        </div>  
			...
			<div class="row">
					...
					<div class="col-lg-6" >
					<input class="form-control" type="text" name="username" value="<?php echo$row[5];?>" required><br>
					</div>
				</div>
