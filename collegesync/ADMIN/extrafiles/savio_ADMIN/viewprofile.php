        ...
        <div class='panel panel-danger'>
          ...
          <div class='panel-body bg-warning'>
				...
				<div class='col-lg-2 col-lg-offset-1'>
						...
						<img src='$row[7]' style='max-width: 170px; max-height: 200px;' class='img img-responsive img-circle'>
						<br>
            ...
            <br><div class='row'>
					...
					<div class='col-lg-6'>
					<input type='E-mail' name='' value='$row[4]' class='form-control' disabled=''><br>
					</div>
				</div>	
			...
			<div class='row'>
				...
				<div class='col-lg-6'>
				<textarea class='form-control' cols='30' rows='2' disabled='' required>$row[2] </textarea><br>
				</div>
			</div>
			...
			<div class='row'>
				...
				<div class='col-lg-6' >
				<input type='Number' name='' value='$row[3]' required class='form-control' minlength='10' disabled=''><br>
				</div>
			</div>
