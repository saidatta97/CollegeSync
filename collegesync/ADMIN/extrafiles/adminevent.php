...
<form method='POST' name='update' action='updateevent.php'>
  ...
  <div class='panel panel-danger' >
    ...
    <div class='row'>
      <div class='col-sm-4 col-sm-offset-4'>
      <center><h1><strong>Event</strong></h1></center>
      <input type='text' name='event_id' value='$row[0]'>
      </div>";
      echo"<div id='del'>";
      ...
      <div class='col-sm-9 col-sm-offset-2'>
              <label><br/><strong>Description about Event::</strong></label><br/><br/>
              <textarea class='form-control' rows='3' name='body' >$row[3]</textarea ><br/>
              </div>
              </div>

          <div class='row'>
          <div class='col-sm-4 col-sm-offset-2'>
              <strong>DATE:<input type='text' name='event_date' class='form-control' value='$row[4]'  ></strong>
           <br> 
           </div>  
             <div class='col-sm-4 col-sm-offset-1'>

              <strong>Time:<input type='text' name='event_time' class='form-control' value='$row[5]'  ></strong>            
            </div>
            </div>
              <br> <br>  
              <div class='row'>
              <div class='col-sm-6 col-sm-offset-2'>
              <label><strong >Address::</strong></label><br>
              <textarea rows='2' cols='40'class='form-control' >$row[6]</textarea ><br/>
