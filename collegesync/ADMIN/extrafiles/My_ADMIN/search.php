...
<div id="design1">
<form>
	<input type="text" name="search"  class="from-control">
	<input type="submit" value="search" class="btn btn-success from-control">
</form>
</div>
<br>
<br>
...
<?php
	...
	echo "<table border=1, cellpadding=1px, cellspacing=1px; class='table table-bordered table-hover table-responsive' >";
	  ...
	  echo"<tr>";
		$query="select * from col_registration where REG_FIRSTNAME like '%$name%' order by REG_ID asc";
