      ...
      <div class="container-fluid">      <!-- <legend style="background:grey;color:white;"><center>QUERY solving </center></legend> -->
        ...
        <div class="panel panel-danger ">
          ...
          <div class="col-sm-8  col-xs-12 col-sm-offset-2">
            ...
            <br>
        <div class="row">
          <div class="col-sm-4  col-xs-8  col-sm-offset-4">
            
            <center><input type="submit" value="Post query" class="form-control btn-primary btn-(size) col-sm-6"></center>
          </div>
        </div>  
          </div>
...
echo"
          <div class='row'>
          <div id='del'>
            <a href='deletequery.php?id=$row[0]'>X</a>
            </div>
...
echo"
        ...
        ?>       
          ...
          <?php     
              ...
              {
             ?>   
             <img src="../USER/userdp/no_image.png" alt='No profile'  style="max-width: 70px; max-height: 70px;" class="img img-responsive img-circle">
